...
const battleMusic = {
  "Ia Drang Valley": "ia_drang_music.mp3",
  "Khe Sanh": "khe_sanh_music.mp3",
  "Hamburger Hill": "hamburger_hill_music.mp3",
  "Hue City": "hue_city_music.mp3",
  "Tet Offensive": "tet_offensive_music.mp3"
};

// Battle images mapping
const battleImages = {
  "Ia Drang Valley": "ia_drang.jpg",
  "Khe Sanh": "khe_sanh.jpg",
  "Hamburger Hill": "hamburger_hill.jpg",
  "Hue City": "hue_city.jpg",
  "Tet Offensive": "tet_offensive.jpg"
};
...
if (infoText) {
  ...
  // Attempt to load and display battle image
  const img = new Image();
  img.src = `images/${battleImages[infoText.title.split(' ').pop()]}`;
  img.onload = () => {
